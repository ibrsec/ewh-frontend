...
const RecentBlogCard = ({ blog }) => {
  ...
  return (
    <Link
      href={blog?.href}
      className="flex gap-5 flex-col group cursor-pointer"
    >
      ...
      <div className="flex-1 flex-col gap-2 flex   ">
        <h3 className="text-2xl  md:text-3xl font-bold poppins-font">
          {blog.title}
        </h3>
        ...
        <p className="text-gray-600 text-lg poppins-font  ">
