...
import { useSelector } from "react-redux";
  ...
  const EkipDeleteModal = ({ open, setOpen, choosedMember }) => {
    const {deleteTeamMember} = useTeamServices();
    ...
    const handleSubmit = (e) => {
      ...
      deleteTeamMember(choosedMember?._id);
              ...
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 ">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    >
                      Are you sure? {choosedMember?.fullName} will be deleted!
                    </DialogTitle>
                    <div className="mt-2">
                      <form
  ...
  export default EkipDeleteModal;
