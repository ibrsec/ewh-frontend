...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:items-stretch  md:justify-between gap-2 pt-8 pb-16 px-2  ">
      <div className="  flex-1 flex flex-col  items-stretch gap-10">
        <div>
          <h1
        ...
        <div className="flex items-center gap-1 justify-center flex-col lg:flex-row ">
          <button
            type="button"
            class="text-dark-red hover:text-light-yellow border border-dark-red hover:bg-dark-red focus:ring-4 focus:outline-none focus:ring-dark-red font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-full lg:w-[200px]"
          >
            Wanna try it out!
          </button>
          <button
      ...
      <div className="flex-1 flex gap-1">
        ...
        <div className="hidden lg:flex flex-col items-center justify-between bg-dark-red rounded-3xl py-4 px-5">
          ...
          <span className="vertical-text manrope-font font-semibold text-lg text-white">Eğitimlerimiz</span>
        </div>
      </div>
    </div>
  );
